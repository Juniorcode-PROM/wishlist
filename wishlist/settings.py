...
SECRET_KEY = 'django-insecure-41a%rp^d125)ve)eh!e*&*^a27$wp=4%caivv@p8k=)29&y07+'
...
DATABASES = {
    ...
    "default-postgres": {
        ...
        "NAME": os.environ.get("PG_NAME") or "wishlist",
...
DATABASES["default"] = DATABASES["default-sqlite"] \
    if DEBUG else DATABASES["default-postgres"]
